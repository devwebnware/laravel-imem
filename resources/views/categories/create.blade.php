<x-app-layout>
    ...
    <section id="form-section">
        <form class="max-w-sm mx-auto" method="POST" action="{{ route('categories.store') }}">
            @csrf
            <div class="mb-5">
                <label for="name" style="margin-bottom: 10px;" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Category Name</label>
            ...
            <button type="submit" class="btn-my-primary" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Add Category</button>
        </form>
    </section>
</x-app-layout>
<style>
